...
// Set user role for header component
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="section-card">
                ...
                <p>Manage practice operations, communications, and compliance.</p>
                <div class="section-links">
    ...
    <!-- Footer -->
    <div class="footer">
        <p>&copy; <?php echo date('Y'); ?> Greater Maryland Pain Management. All rights reserved.</p>
        <p><a href="/privacy">Privacy Policy</a> | <a href="/terms">Terms of Use</a> | <a href="/it-support">IT Support</a></p>
    </div>
