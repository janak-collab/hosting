...
CREATE TABLE `users` (
  ...
  `role` enum('admin','staff','provider') DEFAULT 'staff',
  `active` tinyint(1) DEFAULT 1,
...
INSERT INTO `users` VALUES (3,'admin','','$2y$10$WOU5.k/D6CJyY5HTrz3AR.GsB1tdcY8P123NYQm1gxOy1D8CA69CS','admin',1,0,NULL,NULL,'2025-05-31 12:53:13','2025-06-09 02:28:08','front_desk');
...
-- Dump completed on 2025-06-10  4:15:05
